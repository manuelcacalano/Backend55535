    ...
    addProduct(title, description, price, thumbnail, code, stock){
        ...
        for(let i = 0; i < this.products.length;i++){
            if(this.products[i].code===code){
                return console.log(`el producto con codigo ${code} ya existe`)
            }
        }
        ProductManager.id++
...
products.addProduct('producto prueba2','Este es un segundo producto prueba', 200, 'Sin imagen', 'abc1234', 25)

//Mostrar todos los productos
console.log(products.getProducts());
products.addProduct('producto prueba2','Este es un producto prueba', 200, 'Sin imagen', 'abc1234', 25)  //Debería tirar que el producto con ese codigo ya existe
